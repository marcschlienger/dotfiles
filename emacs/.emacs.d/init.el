...
;; Back up version-controlled files too. Emacs skips them by default, on the
;; assumption that the repository holds the previous content -- but it holds
;; only what was committed, and the edit most worth recovering is the one that
;; was never committed.
